...
import os
import sys
sys.path = ['/root/FL-HAR/FSAR'] + sys.path

import easyfl
from client import FedHARClient
...
def run():
    parser = argparse.ArgumentParser(description='FedHAR Application')
    parser.add_argument('--task_id', type=str, default="")
    parser.add_argument('--data_dir', type=str, metavar='PATH', default="/data/fl")
    parser.add_argument("--datasets", nargs="+", default=None, help="['pku1', 'pku2', 'ntu60', 'ntu120', 'uestc']")
    ...
    easyfl.register_client(FedHARClient)
